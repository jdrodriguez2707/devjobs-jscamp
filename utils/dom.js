...
export const filterSelectTech = document.getElementById('filter-select-tech')
export const filterMenuTech = document.getElementById('filter-menu-tech')
...
// Número de ofertas de empleo por página
